...
const menorFaturamento = Math.min(...faturamento.map((f) => f.valor));

const maiorFaturamento = Math.max(...faturamento.map((f) => f.valor));
...
console.log(
	`Número de dias com faturamento superior à média: ${diasAcimaDaMedia}`,
);
